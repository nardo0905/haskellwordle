...
/* package haskellwordle-0.1.0.0 */
#ifndef VERSION_haskellwordle
#define VERSION_haskellwordle "0.1.0.0"
#endif /* VERSION_haskellwordle */
#ifndef MIN_VERSION_haskellwordle
#define MIN_VERSION_haskellwordle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellwordle */
...
#define CURRENT_COMPONENT_ID "haskellwordle-0.1.0.0-inplace-haskellwordle"
